...
const VoterCard: React.FC<VoterCardProps> = ({ voter, onToggleVoteStatus, onSendReminder, expandedVoterId, onSetExpandedVoterId }) => {
  ...
  const formatVoteTime = (isoString: string | null): string => {
